...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h3 class="text-2xl font-bold text-gray-800 tracking-tight">Sửa chuyên mục</h3>
            <p class="text-sm text-gray-500 mt-1">Cập nhật thông tin chuyên mục: <strong class="text-emerald-600">{{ $category->name }}</strong></p>
        </div>
